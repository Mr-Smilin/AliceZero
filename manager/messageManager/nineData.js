...
module.exports = {
  data: [
    ...
    {
      message: "灰色庭園是世界級的詐寢偶像，最常活躍在21區，喜歡的身體部位是肋骨；欸...你問甚麼是詐寢?到底是甚麼呢...",
      ticket: 1
    },
    {
      message: "LanNI通稱班長，是亞絲娜群的大家長，屁眼迷因的發源人，後來因為跟企鵝心結後很少出現在主群，是位幽默的人",
      ticket: 1
    },
    {
      message: "DVD是莉茲家的招牌，在很多地方都會出現~~跟石頭好像有一腿~~；曾經與主人口頭約定過有機會的話要出來吃個飯，不過因為疫情關係沒甚麼機會",
      ticket: 1
    },
    {
      message: "米戈勒||沒有鼻子||是僅用兩個點跟一條線誕生的天地造物，時常被吐槽少了鼻子，但因為本人充滿自信所以有鼻子。因為疫情關係戴了口罩",
      ticket: 1
    },
    {
      message: "底線是||神代凜子||SAO浮游城群組的管理人，在黃金時代曾舉辦相當多的活動，三觀清晰，管理也十分到位，是大家的大家長~~有傳言說底線是位可愛的女孩子~~",
      ticket: 1
    },
    {
      message: "雞排是07群的超級偶像，因為活動範圍只在07居多，因此較少人認識~~但是非常可愛~~；由於跟雞排組隊打王的人大多都死掉了(半勝)，剋夫雞排傳說不脛而走",
      ticket: 1
    },
    {
      message: "FutYue是詩奶群的~~女裝~~群主，後來因為個人生涯規劃決定引退，但是女裝大佬的稱號並沒有因此而消失，反而成為了不朽的傳奇",
      ticket: 1
    },
    {
      message: "河河就是河河，很可愛",
    ...
    {
      message: "美祿是07群的重要夥伴，談吐間透漏著成熟，偷偷使用神聖術調查後的實際年齡是#@%$#^@永遠的17歲呦～",
      ticket: 1
    },
    {
...
function randomOne(nineDatas) {
  ...
  return lotteryBox[getRandomIntInclusive(0, lotteryBox?.length)];
}
